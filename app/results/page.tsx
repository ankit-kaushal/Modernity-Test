    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 text-center">
          <div
            className={`inline-block p-4 rounded-full bg-gradient-to-r ${getLevelColor(
              level
            )} mb-6 text-6xl`}
          >
            {getLevelEmoji(level)}
          ...
          <div
            className={`inline-block px-6 py-3 rounded-full bg-gradient-to-r ${getLevelColor(
              level
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-8">
            <p className="text-gray-700 dark:text-gray-300 text-lg">
              {percentage >= 80 &&
                "Congratulations! You're at the cutting edge of modernity. You embrace new technologies, trends, and ideas with enthusiasm."}
              {percentage >= 60 &&
                percentage < 80 &&
                "You're quite modern! You stay updated with current trends and are open to new experiences."}
              {percentage >= 40 &&
                percentage < 60 &&
                "You're moderately modern. You balance tradition with contemporary ideas."}
              {percentage >= 20 &&
                percentage < 40 &&
                "You lean towards traditional values while still being open to some modern concepts."}
              {percentage < 20 &&
                "You prefer traditional approaches and values. There's beauty in maintaining classic perspectives."}
            </p>
          </div>
